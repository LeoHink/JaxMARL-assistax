    ...
    def train(rng, lr, ent_coef, clip_eps):
        ...
        def _update_step(runner_state, unused):
            ...
            def _env_step(runner_state, unused):
                ...
                all_done = jnp.expand_dims(all_done, 0)
            ...
            last_val = jnp.broadcast_to(last_val, (env.num_agents, *last_val.shape)) # add ag dim
            ...
            def _update_epoch(update_state, unused):
                ...
                batch = UpdateBatch(
                    init_hstate=ActorCriticHiddenState(
                        actor=jnp.expand_dims( # add step dim
                            update_state.init_hstate.actor,
                            0
                        ),
                        critic=jnp.expand_dims( # add (step, ag) dims
                            update_state.init_hstate.critic,
                            (0,1)
                        ),
                    ),
