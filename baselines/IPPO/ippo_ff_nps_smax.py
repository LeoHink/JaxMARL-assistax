...
from jaxmarl.wrappers.baselines import SMAXLogWrapper as LogWrapper
import hydra
...
class ActorCritic(nn.Module):
    ...
    def __call__(self, x):
        ...
        actor_logits = actor_logits - (1e10 * unavail_actions)
    ...
    def train(rng, lr, ent_coef, clip_eps):
        ...
        def _update_step(runner_state, unused):
            ...
            def _env_step(runner_state, unused):
                ...
                all_done = jnp.expand_dims(done["__all__"], axis=0).repeat(env.num_agents, axis=0)
...
@hydra.main(version_base=None, config_path="config", config_name="ippo_ff_smax")
def main(config):
